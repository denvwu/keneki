...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Denv pogi
\033[1;37m Facebook:          Denv Wu
\033[1;37m Github  :            makati fukiko
\033[1;37m Version :            1000
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://facebook.com/groups/377993316393534/')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100068754884036&mibextid=9R9pXO')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    print(47*'-')
    input(f"{S} Press Enter To Back Riyaz Menu ")
    SSB(allkey)       
